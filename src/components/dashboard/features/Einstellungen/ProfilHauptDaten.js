...
const ProfilHauptDaten = () => {
  ...
  return (
        <div className="profile-first-container">
            ...
            <EinstellungInput text="Strasse" identifier="field-strasse-container" styling={{position: "absolute", top: "45%", left: "0", width: "15%", height: "10%"}}/>
            ...
            <EinstellungInput text="E-Mail-Adresse" identifier="field-email-container" styling={{position: "absolute", top: "60%", left: "60%", width: "15%", height: "10%"}} />
