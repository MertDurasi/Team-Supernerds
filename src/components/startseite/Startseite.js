      ...
      <div>
        <div id="parent">
            ...
            <div id="nav-container">
              <nav id="main-nav">
                <ul>
                  ...
                  <a href="#services" className="hover">
          ...
          <div id="about">
            ...
            <hr></hr>
            <p>
              Wir wollen die Organisation von Firmen weltweit digitalisieren -
              angefangen in <br></br> Deutschland.
            </p>
          ...
          <div id="contact">
            <div>
              ...
              <p>
                ...
                <br></br>
                Treten Sie mit uns in Verbindung, um Ihre Firma einzurichten -
                vollständig
                <br></br>
                kostenlos!
              </p>
