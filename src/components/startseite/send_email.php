<?php
//send_email.php
$email_from = "absender@w-manager.de";   //Absender falls keiner angegeben wurde
$sendermail_antwort = true;      //E-Mail Adresse des Besuchers als Absender. false= Nein ; true = Ja
$name_von_emailfeld = "email";   //Feld in der die Absenderadresse steht
 
$empfaenger = "mert.drs67@gmail.com"; //Empfänger-Adresse
$mail_cc = ""; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
$betreff = "Neue Kontaktanfrage"; //Betreff der Email
 
$url_ok = "localhost:3000"; //Zielseite, wenn E-Mail erfolgreich versendet wurde
$url_fehler = "localhost:3000"; //Zielseite, wenn E-Mail nicht gesendet werden konnte
